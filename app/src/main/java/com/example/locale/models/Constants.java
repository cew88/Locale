...
public class Constants {
    ...
    public static final String INTERESTS_ACTIVITY_TAG = "Interests Activity";
    ...
    // Set constants for Parse for location and JSON objects
    ...
    // Set constants for Interests Activity
